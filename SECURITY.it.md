...
Se trovi questo campione attivo o un'esca correlata, segnala al tuo CERT/CSIRT nazionale e ruota le credenziali esposte (vedi [docs/06-remediation.md](./docs/06-remediation.it.md)).
